        ...
        {tabs.map((tab, idx) => (
          <React.Fragment key={tab.id}>
            ...
            <button
              ...
              className={`flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-2 sm:px-3.5 py-1.5 text-xs font-bold rounded-md transition-all whitespace-nowrap cursor-pointer text-center ${
                activeTab === tab.id
